  ...
  return (
    <div className="flex flex-col gap-6 p-8">
      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <StatCard icon={Users} label={t("adminDashboard.statStudents")} value={stats.totalStudents} color="#0e58a8" href="/admin/foydalanuvchilar" />
            <StatCard icon={GraduationCapIcon} label={t("adminDashboard.statEmployees")} value={stats.totalEmployees} color="#7c3aed" href="/admin/foydalanuvchilar" />
            <StatCard icon={ShieldCheckIcon} label={t("adminDashboard.statGrantedAdmins")} value={stats.grantedAdmins} color="#0891b2" href="/admin/foydalanuvchilar" />
            <StatCard icon={BookOpen} label={t("adminDashboard.statTotalContent")} value={stats.totalContent} color="#15803d" href="/admin/oqituvchilar" />
            ...
            <StatCard icon={CheckCircle2} label={t("adminDashboard.statCompletions")} value={stats.totalCompletions} color="#16a34a" />
